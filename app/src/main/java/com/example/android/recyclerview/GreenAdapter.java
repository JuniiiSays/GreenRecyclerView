...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
     ...
     *                  {@link androidx.appcompat.widget.RecyclerView.Adapter#getItemViewType(int)}
     *                  for more details.
    ...
    public NumberViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        // COMPLETED Set the text of viewHolderIndex to "ViewHolder index: " + viewHolderCount
        viewHolder.viewHolderIndex.setText("viewHolder index: " + viewHolderCount);
        // Use ColorUtils.getViewHolderBackgroundColorFromInstance and pass in a Context and the viewHolderCount
        int backgroundColorOfViewHolder = ColorUtils.getViewHolderBackgroundColorFromInstance(context, viewHolderCount);
        // Set the background color of viewHolder.itemView with the color from above
        viewHolder.itemView.setBackgroundColor(backgroundColorOfViewHolder);
